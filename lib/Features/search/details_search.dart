...
class DetailsSearch extends StatefulWidget {
  ...
  @override
  State<DetailsSearch> createState() => _DetailsScreenState();
}

class _DetailsScreenState extends State<DetailsSearch> {
            ...
            ListView(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Rating(rating: widget.product.ratingsQuantity.toDouble()),
